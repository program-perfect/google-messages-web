...
// React 19 / Next 16 type-checks JSX through React.JSX, while some tooling still
// reads the global JSX namespace. Keep both augmentations in sync.
...
interface MaterialWebIntrinsicElements {
  "md-icon": MWCProps;
  "md-ripple": MWCProps;
  ...
  "md-filled-tonal-button": MWCProps<{ disabled?: boolean; href?: string }>;
...
declare global {
  namespace JSX {
    interface IntrinsicElements extends MaterialWebIntrinsicElements {}
  }
}
